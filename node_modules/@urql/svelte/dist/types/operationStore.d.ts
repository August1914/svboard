 ...
 */
export interface OperationStore<Data = any, Vars = any> extends Readable<OperationStore<Data, Vars>> {
...
export declare function operationStore<Data = any, Vars = object>(query: string | DocumentNode | TypedDocumentNode<Data, Vars>, variables?: Vars | null, context?: Partial<OperationContext & {
    pause: boolean;
