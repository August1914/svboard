...
export declare function subscription<Data = any, Result = Data, Variables = object>(store: OperationStore<Result, Variables>, handler?: SubscriptionHandler<Data, Result>): OperationStore<Result, Variables>;
